pipeline {      
    ...
    stages {
        ...
        stage('Build feature5') {
            steps {
                sh 'echo "running from feature5"'
            }
        }
        stage('Build feature6') {
            steps {
                sh 'echo "running from feature6"'
            }
        }
        stage('Build feature7') {
            steps {
                sh 'echo "running from feature7"'
            }
        }
        stage('Build feature8') {
            steps {
                sh 'echo "running from feature8"'
            }
        }
  }
}
